        ...
        <motion.div
          ...
          <div className='px-4 md:flex lg:flex justify-between items-center space-y-4 md:space-y-0 lg:space-y-0'>
            <div>
              ...
              <p className='text-white text-[12px] font-thin font-sans '>EMAIL ADDRESS — INFO@allieddecore.com</p>
              <p className='text-white text-[12px] font-thin text-sm font-sans pt-2'>PHONE NUMBER — +92 346 0912 630</p>
            </div>
            <div className=' flex space-x-4   '>
              {
                icons.map((item, idx) => {
